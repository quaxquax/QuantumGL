...
["_memory","___indirect_function_table","_printToOutput","_main","onRuntimeInitialized"].forEach((prop) => {
...
function printToOutput(str) { const outputTextarea = document.getElementById('output'); outputTextarea.value += UTF8ToString(str); }
